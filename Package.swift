...
let package = Package(
    ...
    dependencies: [
        ...
        // .package(url: "https://github.com/iTwin/mobile-ios-package", .exact("2.19.14"),        
        .package(name: "itwin-mobile-ios", url: "https://github.com/toddsouthenbentley/itwin-iostest", .exact("2.19.14")),
    ...
    targets: [
        ...
        .target(
            name: "ITwinMobile",
            dependencies: [
                .product(name: "IModelJsNative", package: "itwin-mobile-ios"),
